...
import { computeStats } from "../../../graph-server/src/analysis/stats.js";
...
describe("computeStats", () => {
    ...
    it("computes source breakdown correctly", () => {
        ...
        // lastfm: A(10) + B(7) + C(4) + D(1) = 22 scrobbles
        expect(sb["lastfm"]).toBe(22);
    });
