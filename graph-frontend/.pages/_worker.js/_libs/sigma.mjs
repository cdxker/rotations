...
import { r as requireIsGraph } from "./graphology-utils.mjs";
var sigma_cjs = { exports: {} };
var sigma_cjs_prod = {};
var index16136237_cjs_prod = {};
var inherits6434e089_cjs_prod = {};
var hasRequiredInherits6434e089_cjs_prod;
function requireInherits6434e089_cjs_prod() {
  if (hasRequiredInherits6434e089_cjs_prod) return inherits6434e089_cjs_prod;
  hasRequiredInherits6434e089_cjs_prod = 1;
  ...
  inherits6434e089_cjs_prod._callSuper = _callSuper;
  inherits6434e089_cjs_prod._classCallCheck = _classCallCheck;
  inherits6434e089_cjs_prod._createClass = _createClass;
  inherits6434e089_cjs_prod._getPrototypeOf = _getPrototypeOf;
  inherits6434e089_cjs_prod._inherits = _inherits;
  inherits6434e089_cjs_prod._toPropertyKey = _toPropertyKey;
  return inherits6434e089_cjs_prod;
}
var colorsEe2e2828_cjs_prod = {};
var hasRequiredColorsEe2e2828_cjs_prod;
function requireColorsEe2e2828_cjs_prod() {
  if (hasRequiredColorsEe2e2828_cjs_prod) return colorsEe2e2828_cjs_prod;
  hasRequiredColorsEe2e2828_cjs_prod = 1;
  ...
  colorsEe2e2828_cjs_prod.HTML_COLORS = HTML_COLORS;
  colorsEe2e2828_cjs_prod._arrayLikeToArray = _arrayLikeToArray;
  colorsEe2e2828_cjs_prod._slicedToArray = _slicedToArray;
  colorsEe2e2828_cjs_prod._unsupportedIterableToArray = _unsupportedIterableToArray;
  colorsEe2e2828_cjs_prod.colorToArray = colorToArray;
  colorsEe2e2828_cjs_prod.colorToIndex = colorToIndex;
  colorsEe2e2828_cjs_prod.extractPixel = extractPixel;
  colorsEe2e2828_cjs_prod.floatColor = floatColor;
  colorsEe2e2828_cjs_prod.getPixelColor = getPixelColor;
  colorsEe2e2828_cjs_prod.indexToColor = indexToColor;
  colorsEe2e2828_cjs_prod.parseColor = parseColor;
  colorsEe2e2828_cjs_prod.rgbaToFloat = rgbaToFloat;
  return colorsEe2e2828_cjs_prod;
}
var hasRequiredIndex16136237_cjs_prod;
function requireIndex16136237_cjs_prod() {
  if (hasRequiredIndex16136237_cjs_prod) return index16136237_cjs_prod;
  hasRequiredIndex16136237_cjs_prod = 1;
  var inherits = /* @__PURE__ */ requireInherits6434e089_cjs_prod();
  var colors = /* @__PURE__ */ requireColorsEe2e2828_cjs_prod();
  ...
  function _superPropGet(t, o, e, r) {
    var p = _get(inherits._getPrototypeOf(t.prototype), o, e);
  ...
  var AbstractProgram = /* @__PURE__ */ inherits._createClass(function AbstractProgram2(_gl, _pickGl, _renderer) {
    inherits._classCallCheck(this, AbstractProgram2);
  });
  var Program = /* @__PURE__ */ (function() {
    function Program2(gl, pickingBuffer, renderer) {
      inherits._classCallCheck(this, Program2);
    ...
    return inherits._createClass(Program2, [{
      key: "kill",
      value: function kill() {
  ...
  var AbstractNodeProgram = /* @__PURE__ */ (function(_AbstractProgram) {
    function AbstractNodeProgram2() {
      inherits._classCallCheck(this, AbstractNodeProgram2);
      return inherits._callSuper(this, AbstractNodeProgram2, arguments);
    }
    inherits._inherits(AbstractNodeProgram2, _AbstractProgram);
    return inherits._createClass(AbstractNodeProgram2);
  })(AbstractProgram);
  var NodeProgram = /* @__PURE__ */ (function(_ref) {
    function NodeProgram2() {
      inherits._classCallCheck(this, NodeProgram2);
      return inherits._callSuper(this, NodeProgram2, arguments);
    }
    inherits._inherits(NodeProgram2, _ref);
    return inherits._createClass(NodeProgram2, [{
      key: "kill",
      value: function kill() {
        _superPropGet(NodeProgram2, "kill", this)([]);
      }
    }, {
      key: "process",
  ...
  var AbstractEdgeProgram = /* @__PURE__ */ (function(_AbstractProgram) {
    function AbstractEdgeProgram2() {
      inherits._classCallCheck(this, AbstractEdgeProgram2);
      return inherits._callSuper(this, AbstractEdgeProgram2, arguments);
    }
    inherits._inherits(AbstractEdgeProgram2, _AbstractProgram);
    return inherits._createClass(AbstractEdgeProgram2);
  })(AbstractProgram);
  var EdgeProgram = /* @__PURE__ */ (function(_ref) {
    function EdgeProgram2() {
      var _this;
      inherits._classCallCheck(this, EdgeProgram2);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = inherits._callSuper(this, EdgeProgram2, [].concat(args));
      _defineProperty(_this, "drawLabel", void 0);
      return _this;
    }
    inherits._inherits(EdgeProgram2, _ref);
    return inherits._createClass(EdgeProgram2, [{
      key: "kill",
      value: function kill() {
        _superPropGet(EdgeProgram2, "kill", this)([]);
      }
    }, {
      key: "process",
  ...
  var NodeCircleProgram = /* @__PURE__ */ (function(_NodeProgram) {
    function NodeCircleProgram2() {
      inherits._classCallCheck(this, NodeCircleProgram2);
      return inherits._callSuper(this, NodeCircleProgram2, arguments);
    }
    inherits._inherits(NodeCircleProgram2, _NodeProgram);
    return inherits._createClass(NodeCircleProgram2, [{
      key: "getDefinition",
  ...
  function createEdgeArrowHeadProgram(inputOptions) {
    ...
    return /* @__PURE__ */ (function(_EdgeProgram) {
      function EdgeArrowHeadProgram2() {
        inherits._classCallCheck(this, EdgeArrowHeadProgram2);
        return inherits._callSuper(this, EdgeArrowHeadProgram2, arguments);
      }
      inherits._inherits(EdgeArrowHeadProgram2, _EdgeProgram);
      return inherits._createClass(EdgeArrowHeadProgram2, [{
        key: "getDefinition",
        value: function getDefinition() {
          return {
            VERTICES: 3,
  ...
  function createEdgeClampedProgram(inputOptions) {
    ...
    return /* @__PURE__ */ (function(_EdgeProgram) {
      function EdgeClampedProgram2() {
        inherits._classCallCheck(this, EdgeClampedProgram2);
        return inherits._callSuper(this, EdgeClampedProgram2, arguments);
      }
      inherits._inherits(EdgeClampedProgram2, _EdgeProgram);
      return inherits._createClass(EdgeClampedProgram2, [{
        key: "getDefinition",
        value: function getDefinition() {
          return {
            VERTICES: 6,
...
`
  ...
  var EdgeRectangleProgram = /* @__PURE__ */ (function(_EdgeProgram) {
    function EdgeRectangleProgram2() {
      inherits._classCallCheck(this, EdgeRectangleProgram2);
      return inherits._callSuper(this, EdgeRectangleProgram2, arguments);
    }
    inherits._inherits(EdgeRectangleProgram2, _EdgeProgram);
    return inherits._createClass(EdgeRectangleProgram2, [{
      key: "getDefinition",
      value: function getDefinition() {
        return {
          VERTICES: 6,
  ...
  index16136237_cjs_prod.AbstractEdgeProgram = AbstractEdgeProgram;
  index16136237_cjs_prod.AbstractNodeProgram = AbstractNodeProgram;
  index16136237_cjs_prod.AbstractProgram = AbstractProgram;
  index16136237_cjs_prod.DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS = DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS;
  index16136237_cjs_prod.DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS = DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS;
  index16136237_cjs_prod.EdgeArrowHeadProgram = EdgeArrowHeadProgram$1;
  index16136237_cjs_prod.EdgeArrowProgram = EdgeArrowProgram$1;
  index16136237_cjs_prod.EdgeClampedProgram = EdgeClampedProgram$1;
  index16136237_cjs_prod.EdgeProgram = EdgeProgram;
  index16136237_cjs_prod.EdgeRectangleProgram = EdgeRectangleProgram;
  index16136237_cjs_prod.FRAGMENT_SHADER_SOURCE = FRAGMENT_SHADER_SOURCE;
  index16136237_cjs_prod.NodeCircleProgram = NodeCircleProgram;
  index16136237_cjs_prod.NodeProgram = NodeProgram;
  index16136237_cjs_prod.Program = Program;
  index16136237_cjs_prod._defineProperty = _defineProperty;
  index16136237_cjs_prod._objectSpread2 = _objectSpread2;
  index16136237_cjs_prod.createEdgeArrowHeadProgram = createEdgeArrowHeadProgram;
  index16136237_cjs_prod.createEdgeArrowProgram = createEdgeArrowProgram;
  index16136237_cjs_prod.createEdgeClampedProgram = createEdgeClampedProgram;
  index16136237_cjs_prod.createEdgeCompoundProgram = createEdgeCompoundProgram;
  index16136237_cjs_prod.createNodeCompoundProgram = createNodeCompoundProgram;
  index16136237_cjs_prod.drawDiscNodeHover = drawDiscNodeHover;
  index16136237_cjs_prod.drawDiscNodeLabel = drawDiscNodeLabel;
  index16136237_cjs_prod.drawStraightEdgeLabel = drawStraightEdgeLabel;
  index16136237_cjs_prod.getAttributeItemsCount = getAttributeItemsCount;
  index16136237_cjs_prod.getAttributesItemsCount = getAttributesItemsCount;
  index16136237_cjs_prod.killProgram = killProgram;
  index16136237_cjs_prod.loadFragmentShader = loadFragmentShader;
  index16136237_cjs_prod.loadProgram = loadProgram;
  index16136237_cjs_prod.loadVertexShader = loadVertexShader;
  index16136237_cjs_prod.numberToGLSLFloat = numberToGLSLFloat;
  return index16136237_cjs_prod;
}
var sigmaTypes_cjs_prod = {};
var hasRequiredSigmaTypes_cjs_prod;
function requireSigmaTypes_cjs_prod() {
  if (hasRequiredSigmaTypes_cjs_prod) return sigmaTypes_cjs_prod;
  hasRequiredSigmaTypes_cjs_prod = 1;
  Object.defineProperty(sigmaTypes_cjs_prod, "__esModule", { value: true });
  var inherits = /* @__PURE__ */ requireInherits6434e089_cjs_prod();
  var events = require$$1;
  var TypedEventEmitter = /* @__PURE__ */ (function(_ref) {
    function TypedEventEmitter2() {
      var _this;
      inherits._classCallCheck(this, TypedEventEmitter2);
      _this = inherits._callSuper(this, TypedEventEmitter2);
      _this.rawEmitter = _this;
      return _this;
    }
    inherits._inherits(TypedEventEmitter2, _ref);
    return inherits._createClass(TypedEventEmitter2);
  })(events.EventEmitter);
  sigmaTypes_cjs_prod.TypedEventEmitter = TypedEventEmitter;
  return sigmaTypes_cjs_prod;
}
var normalizationAed467cc_cjs_prod = {};
var hasRequiredNormalizationAed467cc_cjs_prod;
function requireNormalizationAed467cc_cjs_prod() {
  if (hasRequiredNormalizationAed467cc_cjs_prod) return normalizationAed467cc_cjs_prod;
  hasRequiredNormalizationAed467cc_cjs_prod = 1;
  var isGraph = /* @__PURE__ */ requireIsGraph();
  var colors = /* @__PURE__ */ requireColorsEe2e2828_cjs_prod();
  ...
  function createNormalizationFunction(extent) {
    var _extent$x = colors._slicedToArray(extent.x, 2), minX = _extent$x[0], maxX = _extent$x[1], _extent$y = colors._slicedToArray(extent.y, 2), minY = _extent$y[0], maxY = _extent$y[1];
  ...
  normalizationAed467cc_cjs_prod.ANIMATE_DEFAULTS = ANIMATE_DEFAULTS;
  normalizationAed467cc_cjs_prod.animateNodes = animateNodes;
  normalizationAed467cc_cjs_prod.createElement = createElement;
  normalizationAed467cc_cjs_prod.createNormalizationFunction = createNormalizationFunction;
  normalizationAed467cc_cjs_prod.cubicIn = cubicIn;
  normalizationAed467cc_cjs_prod.cubicInOut = cubicInOut;
  normalizationAed467cc_cjs_prod.cubicOut = cubicOut;
  normalizationAed467cc_cjs_prod.easings = easings;
  normalizationAed467cc_cjs_prod.getCorrectionRatio = getCorrectionRatio;
  normalizationAed467cc_cjs_prod.getMatrixImpact = getMatrixImpact;
  normalizationAed467cc_cjs_prod.getPixelRatio = getPixelRatio;
  normalizationAed467cc_cjs_prod.graphExtent = graphExtent;
  normalizationAed467cc_cjs_prod.identity = identity;
  normalizationAed467cc_cjs_prod.linear = linear;
  normalizationAed467cc_cjs_prod.matrixFromCamera = matrixFromCamera;
  normalizationAed467cc_cjs_prod.multiply = multiply;
  normalizationAed467cc_cjs_prod.multiplyVec2 = multiplyVec2;
  normalizationAed467cc_cjs_prod.quadraticIn = quadraticIn;
  normalizationAed467cc_cjs_prod.quadraticInOut = quadraticInOut;
  normalizationAed467cc_cjs_prod.quadraticOut = quadraticOut;
  normalizationAed467cc_cjs_prod.rotate = rotate;
  normalizationAed467cc_cjs_prod.scale = scale;
  normalizationAed467cc_cjs_prod.translate = translate;
  normalizationAed467cc_cjs_prod.validateGraph = validateGraph;
  normalizationAed467cc_cjs_prod.zIndexOrdering = zIndexOrdering;
  return normalizationAed467cc_cjs_prod;
}
var sigmaSettings_cjs_prod = {};
var data881001cd_cjs_prod = {};
var hasRequiredData881001cd_cjs_prod;
function requireData881001cd_cjs_prod() {
  if (hasRequiredData881001cd_cjs_prod) return data881001cd_cjs_prod;
  hasRequiredData881001cd_cjs_prod = 1;
  function _typeof(o) {
  ...
  data881001cd_cjs_prod._typeof = _typeof;
  data881001cd_cjs_prod.assign = assign;
  data881001cd_cjs_prod.assignDeep = assignDeep;
  data881001cd_cjs_prod.extend = extend;
  data881001cd_cjs_prod.isPlainObject = isPlainObject;
  return data881001cd_cjs_prod;
}
var hasRequiredSigmaSettings_cjs_prod;
function requireSigmaSettings_cjs_prod() {
  if (hasRequiredSigmaSettings_cjs_prod) return sigmaSettings_cjs_prod;
  hasRequiredSigmaSettings_cjs_prod = 1;
  Object.defineProperty(sigmaSettings_cjs_prod, "__esModule", { value: true });
  var index = /* @__PURE__ */ requireIndex16136237_cjs_prod();
  var data = /* @__PURE__ */ requireData881001cd_cjs_prod();
  ...
  sigmaSettings_cjs_prod.DEFAULT_EDGE_PROGRAM_CLASSES = DEFAULT_EDGE_PROGRAM_CLASSES;
  sigmaSettings_cjs_prod.DEFAULT_NODE_PROGRAM_CLASSES = DEFAULT_NODE_PROGRAM_CLASSES;
  sigmaSettings_cjs_prod.DEFAULT_SETTINGS = DEFAULT_SETTINGS;
  sigmaSettings_cjs_prod.resolveSettings = resolveSettings;
  sigmaSettings_cjs_prod.validateSettings = validateSettings;
  return sigmaSettings_cjs_prod;
}
var hasRequiredSigma_cjs_prod;
function requireSigma_cjs_prod() {
  if (hasRequiredSigma_cjs_prod) return sigma_cjs_prod;
  hasRequiredSigma_cjs_prod = 1;
  (function(exports$1) {
    Object.defineProperty(exports$1, "__esModule", { value: true });
    var index = /* @__PURE__ */ requireIndex16136237_cjs_prod();
    var inherits = /* @__PURE__ */ requireInherits6434e089_cjs_prod();
    var types_dist_sigmaTypes = /* @__PURE__ */ requireSigmaTypes_cjs_prod();
    var normalization = /* @__PURE__ */ requireNormalizationAed467cc_cjs_prod();
    var settings_dist_sigmaSettings = /* @__PURE__ */ requireSigmaSettings_cjs_prod();
    var colors = /* @__PURE__ */ requireColorsEe2e2828_cjs_prod();
    var data = /* @__PURE__ */ requireData881001cd_cjs_prod();
    ...
    var Camera = /* @__PURE__ */ (function(_TypedEventEmitter) {
      function Camera2() {
        var _this;
        inherits._classCallCheck(this, Camera2);
        _this = inherits._callSuper(this, Camera2);
      ...
      inherits._inherits(Camera2, _TypedEventEmitter);
      return inherits._createClass(Camera2, [{
        key: "enable",
        value: (
          /**
    ...
    var Captor = /* @__PURE__ */ (function(_TypedEventEmitter) {
      function Captor2(container, renderer) {
        var _this;
        inherits._classCallCheck(this, Captor2);
        _this = inherits._callSuper(this, Captor2);
        _this.container = container;
        _this.renderer = renderer;
        return _this;
      }
      inherits._inherits(Captor2, _TypedEventEmitter);
      return inherits._createClass(Captor2);
    })(types_dist_sigmaTypes.TypedEventEmitter);
    ...
    var MouseCaptor = /* @__PURE__ */ (function(_Captor) {
      function MouseCaptor2(container, renderer) {
        var _this;
        inherits._classCallCheck(this, MouseCaptor2);
        _this = inherits._callSuper(this, MouseCaptor2, [container, renderer]);
        index._defineProperty(_this, "enabled", true);
      ...
      inherits._inherits(MouseCaptor2, _Captor);
      return inherits._createClass(MouseCaptor2, [{
        key: "kill",
        value: function kill() {
    ...
    var TouchCaptor = /* @__PURE__ */ (function(_Captor) {
      function TouchCaptor2(container, renderer) {
        var _this;
        inherits._classCallCheck(this, TouchCaptor2);
        _this = inherits._callSuper(this, TouchCaptor2, [container, renderer]);
        index._defineProperty(_this, "enabled", true);
        index._defineProperty(_this, "isMoving", false);
      ...
      inherits._inherits(TouchCaptor2, _Captor);
      return inherits._createClass(TouchCaptor2, [{
        key: "kill",
        value: function kill() {
          var container = this.container;
        ...
        value: function handleStart(e) {
          ...
          if (this.touchMode === 2) {
            var _this$startTouchesPos = colors._slicedToArray(this.startTouchesPositions, 2), _this$startTouchesPos2 = _this$startTouchesPos[0], x0 = _this$startTouchesPos2.x, y0 = _this$startTouchesPos2.y, _this$startTouchesPos3 = _this$startTouchesPos[1], x1 = _this$startTouchesPos3.x, y1 = _this$startTouchesPos3.y;
    ...
    var LabelCandidate = /* @__PURE__ */ (function() {
      function LabelCandidate2(key, size) {
        inherits._classCallCheck(this, LabelCandidate2);
        this.key = key;
        this.size = size;
      }
      return inherits._createClass(LabelCandidate2, null, [{
        key: "compare",
    ...
    var LabelGrid = /* @__PURE__ */ (function() {
      function LabelGrid2() {
        inherits._classCallCheck(this, LabelGrid2);
      ...
      return inherits._createClass(LabelGrid2, [{
        key: "resizeAndClear",
    ...
    function applyNodeDefaults(settings, key, data2) {
      if (!hasOwnProperty.call(data2, "x") || !hasOwnProperty.call(data2, "y")) throw new Error('Sigma: could not find a valid position (x, y) for node "'.concat(key, '". All your nodes must have a number "x" and "y". Maybe your forgot to apply a layout or your "nodeReducer" is not returning the correct data?'));
      if (!data2.color) data2.color = settings.defaultNodeColor;
      if (!data2.label && data2.label !== "") data2.label = null;
      if (data2.label !== void 0 && data2.label !== null) data2.label = "" + data2.label;
      else data2.label = null;
      if (!data2.size) data2.size = 2;
      if (!hasOwnProperty.call(data2, "hidden")) data2.hidden = false;
      if (!hasOwnProperty.call(data2, "highlighted")) data2.highlighted = false;
      if (!hasOwnProperty.call(data2, "forceLabel")) data2.forceLabel = false;
      if (!data2.type || data2.type === "") data2.type = settings.defaultNodeType;
      if (!data2.zIndex) data2.zIndex = 0;
      return data2;
    }
    function applyEdgeDefaults(settings, _key, data2) {
      if (!data2.color) data2.color = settings.defaultEdgeColor;
      if (!data2.label) data2.label = "";
      if (!data2.size) data2.size = 0.5;
      if (!hasOwnProperty.call(data2, "hidden")) data2.hidden = false;
      if (!hasOwnProperty.call(data2, "forceLabel")) data2.forceLabel = false;
      if (!data2.type || data2.type === "") data2.type = settings.defaultEdgeType;
      if (!data2.zIndex) data2.zIndex = 0;
      return data2;
    }
    var Sigma$1 = /* @__PURE__ */ (function(_TypedEventEmitter) {
      function Sigma2(graph, container) {
        ...
        inherits._classCallCheck(this, Sigma2);
        _this = inherits._callSuper(this, Sigma2);
        index._defineProperty(_this, "elements", {});
        index._defineProperty(_this, "canvasContexts", {});
        index._defineProperty(_this, "webGLContexts", {});
        index._defineProperty(_this, "pickingLayers", /* @__PURE__ */ new Set());
        ...
        index._defineProperty(_this, "nodesWithForcedLabels", /* @__PURE__ */ new Set());
        index._defineProperty(_this, "edgesWithForcedLabels", /* @__PURE__ */ new Set());
        ...
        index._defineProperty(_this, "displayedNodeLabels", /* @__PURE__ */ new Set());
        index._defineProperty(_this, "displayedEdgeLabels", /* @__PURE__ */ new Set());
        index._defineProperty(_this, "highlightedNodes", /* @__PURE__ */ new Set());
      ...
      inherits._inherits(Sigma2, _TypedEventEmitter);
      return inherits._createClass(Sigma2, [{
        ...
        value: function unregisterNodeProgram(key) {
          if (this.nodePrograms[key]) {
            var _this$nodePrograms = this.nodePrograms, program = _this$nodePrograms[key], programs = _objectWithoutProperties(_this$nodePrograms, [key].map(inherits._toPropertyKey));
            program.kill();
            this.nodePrograms = programs;
          }
          if (this.nodeHoverPrograms[key]) {
            var _this$nodeHoverProgra = this.nodeHoverPrograms, _program = _this$nodeHoverProgra[key], _programs = _objectWithoutProperties(_this$nodeHoverProgra, [key].map(inherits._toPropertyKey));
            _program.kill();
        ...
        value: function unregisterEdgeProgram(key) {
          if (this.edgePrograms[key]) {
            var _this$edgePrograms = this.edgePrograms, program = _this$edgePrograms[key], programs = _objectWithoutProperties(_this$edgePrograms, [key].map(inherits._toPropertyKey));
            program.kill();
        ...
        value: function getNodeAtPosition(position) {
          ...
          var index2 = colors.colorToIndex.apply(void 0, _toConsumableArray(color));
        ...
        value: function process() {
          ...
          for (var i = 0, l = nodes.length; i < l; i++) {
            var node = nodes[i];
            var data2 = this.nodeDataCache[node];
            var attrs = graph.getNodeAttributes(node);
            data2.x = attrs.x;
            data2.y = attrs.y;
            this.normalizationFunction.applyTo(data2);
            if (typeof data2.label === "string" && !data2.hidden) this.labelGrid.add(node, data2.size, this.framedGraphToViewport(data2, {
              matrix: nullCameraMatrix
            }));
            nodesPerPrograms[data2.type] = (nodesPerPrograms[data2.type] || 0) + 1;
          }
          ...
          if (this.settings.zIndex && this.nodeZExtent[0] !== this.nodeZExtent[1]) nodes = normalization.zIndexOrdering(this.nodeZExtent, function(node2) {
          ...
          if (this.settings.zIndex && this.edgeZExtent[0] !== this.edgeZExtent[1]) edges = normalization.zIndexOrdering(this.edgeZExtent, function(edge2) {
        ...
        value: function cleanCameraState(state) {
          ...
          var _ref2 = boundaries || this.nodeExtent, _ref2$x = colors._slicedToArray(_ref2.x, 2), xMinGraph = _ref2$x[0], xMaxGraph = _ref2$x[1], _ref2$y = colors._slicedToArray(_ref2.y, 2), yMinGraph = _ref2$y[0], yMaxGraph = _ref2$y[1];
        ...
        value: function renderLabels() {
          ...
          for (var i = 0, l = labelsToDisplay.length; i < l; i++) {
            ...
            var _this$framedGraphToVi = this.framedGraphToViewport(data$1), x = _this$framedGraphToVi.x, y = _this$framedGraphToVi.y;
        ...
        value: function renderHighlightedNodes() {
          ...
          var render = function render2(node) {
            var data2 = _this7.nodeDataCache[node];
            var _this7$framedGraphToV = _this7.framedGraphToViewport(data2), x = _this7$framedGraphToV.x, y = _this7$framedGraphToV.y;
            var size = _this7.scaleSize(data2.size);
            var defaultDrawNodeHover = _this7.settings.defaultDrawNodeHover;
            var nodeProgram = _this7.nodePrograms[data2.type];
          ...
          nodesToRender.forEach(function(node) {
            var data2 = _this7.nodeDataCache[node];
            _this7.nodeHoverPrograms[data2.type].process(0, nodesPerPrograms[data2.type]++, data2);
          });
        ...
        value: function addNode(key) {
          ...
          var data2 = applyNodeDefaults(this.settings, key, attr);
          this.nodeDataCache[key] = data2;
          this.nodesWithForcedLabels["delete"](key);
          if (data2.forceLabel && !data2.hidden) this.nodesWithForcedLabels.add(key);
          this.highlightedNodes["delete"](key);
          if (data2.highlighted && !data2.hidden) this.highlightedNodes.add(key);
          if (this.settings.zIndex) {
            if (data2.zIndex < this.nodeZExtent[0]) this.nodeZExtent[0] = data2.zIndex;
            if (data2.zIndex > this.nodeZExtent[1]) this.nodeZExtent[1] = data2.zIndex;
          }
        }
        /**
        ...
        value: function updateNode(key) {
          this.addNode(key);
          var data2 = this.nodeDataCache[key];
          this.normalizationFunction.applyTo(data2);
        }
        /**
        ...
        value: function addEdge(key) {
          ...
          var data2 = applyEdgeDefaults(this.settings, key, attr);
          this.edgeDataCache[key] = data2;
          this.edgesWithForcedLabels["delete"](key);
          if (data2.forceLabel && !data2.hidden) this.edgesWithForcedLabels.add(key);
          if (this.settings.zIndex) {
            if (data2.zIndex < this.edgeZExtent[0]) this.edgeZExtent[0] = data2.zIndex;
            if (data2.zIndex > this.edgeZExtent[1]) this.edgeZExtent[1] = data2.zIndex;
          }
        }
        /**
        ...
        value: function addNodeToProgram(node, fingerprint, position) {
          var data2 = this.nodeDataCache[node];
          var nodeProgram = this.nodePrograms[data2.type];
          if (!nodeProgram) throw new Error('Sigma: could not find a suitable program for node type "'.concat(data2.type, '"!'));
          nodeProgram.process(fingerprint, position, data2);
        ...
        value: function addEdgeToProgram(edge, fingerprint, position) {
          var data2 = this.edgeDataCache[edge];
          var edgeProgram = this.edgePrograms[data2.type];
          if (!edgeProgram) throw new Error('Sigma: could not find a suitable program for edge type "'.concat(data2.type, '"!'));
          ...
          edgeProgram.process(fingerprint, position, sourceData, targetData, data2);
    ...
    exports$1.MouseCaptor = MouseCaptor;
    exports$1.Sigma = Sigma$1;
    exports$1.TouchCaptor = TouchCaptor;
    exports$1["default"] = Sigma;
  })(sigma_cjs_prod);
  return sigma_cjs_prod;
}
var hasRequiredSigma_cjs;
function requireSigma_cjs() {
  if (hasRequiredSigma_cjs) return sigma_cjs.exports;
  hasRequiredSigma_cjs = 1;
  {
    sigma_cjs.exports = /* @__PURE__ */ requireSigma_cjs_prod();
  }
  return sigma_cjs.exports;
}
var sigma_cjsExports = /* @__PURE__ */ requireSigma_cjs();
var sigmaRendering_cjs$1 = { exports: {} };
var sigmaRendering_cjs_prod = {};
var hasRequiredSigmaRendering_cjs_prod;
function requireSigmaRendering_cjs_prod() {
  if (hasRequiredSigmaRendering_cjs_prod) return sigmaRendering_cjs_prod;
  hasRequiredSigmaRendering_cjs_prod = 1;
  Object.defineProperty(sigmaRendering_cjs_prod, "__esModule", { value: true });
  var index = /* @__PURE__ */ requireIndex16136237_cjs_prod();
  var inherits = /* @__PURE__ */ requireInherits6434e089_cjs_prod();
  var colors = /* @__PURE__ */ requireColorsEe2e2828_cjs_prod();
  var SHADER_SOURCE$6 = (
  ...
  var NodePointProgram = /* @__PURE__ */ (function(_NodeProgram) {
    function NodePointProgram2() {
      inherits._classCallCheck(this, NodePointProgram2);
      return inherits._callSuper(this, NodePointProgram2, arguments);
    }
    inherits._inherits(NodePointProgram2, _NodeProgram);
    return inherits._createClass(NodePointProgram2, [{
      key: "getDefinition",
      value: function getDefinition() {
        return {
          VERTICES: 1,
  ...
  function createEdgeDoubleClampedProgram(inputOptions) {
    ...
    return /* @__PURE__ */ (function(_EdgeProgram) {
      function EdgeDoubleClampedProgram2() {
        inherits._classCallCheck(this, EdgeDoubleClampedProgram2);
        return inherits._callSuper(this, EdgeDoubleClampedProgram2, arguments);
      }
      inherits._inherits(EdgeDoubleClampedProgram2, _EdgeProgram);
      return inherits._createClass(EdgeDoubleClampedProgram2, [{
        key: "getDefinition",
        value: function getDefinition() {
          return {
            VERTICES: 6,
  ...
  var EdgeLineProgram = /* @__PURE__ */ (function(_EdgeProgram) {
    function EdgeLineProgram2() {
      inherits._classCallCheck(this, EdgeLineProgram2);
      return inherits._callSuper(this, EdgeLineProgram2, arguments);
    }
    inherits._inherits(EdgeLineProgram2, _EdgeProgram);
    return inherits._createClass(EdgeLineProgram2, [{
      key: "getDefinition",
      value: function getDefinition() {
        return {
          VERTICES: 2,
  ...
  var EdgeTriangleProgram = /* @__PURE__ */ (function(_EdgeProgram) {
    function EdgeTriangleProgram2() {
      inherits._classCallCheck(this, EdgeTriangleProgram2);
      return inherits._callSuper(this, EdgeTriangleProgram2, arguments);
    }
    inherits._inherits(EdgeTriangleProgram2, _EdgeProgram);
    return inherits._createClass(EdgeTriangleProgram2, [{
      key: "getDefinition",
      value: function getDefinition() {
        return {
          VERTICES: 3,
  ...
  sigmaRendering_cjs_prod.AbstractEdgeProgram = index.AbstractEdgeProgram;
  sigmaRendering_cjs_prod.AbstractNodeProgram = index.AbstractNodeProgram;
  sigmaRendering_cjs_prod.AbstractProgram = index.AbstractProgram;
  sigmaRendering_cjs_prod.DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS = index.DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS;
  sigmaRendering_cjs_prod.DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS = index.DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS;
  sigmaRendering_cjs_prod.EdgeArrowHeadProgram = index.EdgeArrowHeadProgram;
  sigmaRendering_cjs_prod.EdgeArrowProgram = index.EdgeArrowProgram;
  sigmaRendering_cjs_prod.EdgeClampedProgram = index.EdgeClampedProgram;
  sigmaRendering_cjs_prod.EdgeProgram = index.EdgeProgram;
  sigmaRendering_cjs_prod.EdgeRectangleProgram = index.EdgeRectangleProgram;
  sigmaRendering_cjs_prod.NodeCircleProgram = index.NodeCircleProgram;
  sigmaRendering_cjs_prod.NodeProgram = index.NodeProgram;
  sigmaRendering_cjs_prod.Program = index.Program;
  sigmaRendering_cjs_prod.createEdgeArrowHeadProgram = index.createEdgeArrowHeadProgram;
  sigmaRendering_cjs_prod.createEdgeArrowProgram = index.createEdgeArrowProgram;
  sigmaRendering_cjs_prod.createEdgeClampedProgram = index.createEdgeClampedProgram;
  sigmaRendering_cjs_prod.createEdgeCompoundProgram = index.createEdgeCompoundProgram;
  sigmaRendering_cjs_prod.createNodeCompoundProgram = index.createNodeCompoundProgram;
  sigmaRendering_cjs_prod.drawDiscNodeHover = index.drawDiscNodeHover;
  sigmaRendering_cjs_prod.drawDiscNodeLabel = index.drawDiscNodeLabel;
  sigmaRendering_cjs_prod.drawStraightEdgeLabel = index.drawStraightEdgeLabel;
  sigmaRendering_cjs_prod.getAttributeItemsCount = index.getAttributeItemsCount;
  sigmaRendering_cjs_prod.getAttributesItemsCount = index.getAttributesItemsCount;
  sigmaRendering_cjs_prod.killProgram = index.killProgram;
  sigmaRendering_cjs_prod.loadFragmentShader = index.loadFragmentShader;
  sigmaRendering_cjs_prod.loadProgram = index.loadProgram;
  sigmaRendering_cjs_prod.loadVertexShader = index.loadVertexShader;
  sigmaRendering_cjs_prod.numberToGLSLFloat = index.numberToGLSLFloat;
  sigmaRendering_cjs_prod.DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS = DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS;
  sigmaRendering_cjs_prod.EdgeDoubleArrowProgram = EdgeDoubleArrowProgram$1;
  sigmaRendering_cjs_prod.EdgeDoubleClampedProgram = EdgeDoubleClampedProgram$1;
  sigmaRendering_cjs_prod.EdgeLineProgram = EdgeLineProgram;
  sigmaRendering_cjs_prod.EdgeTriangleProgram = EdgeTriangleProgram;
  sigmaRendering_cjs_prod.NodePointProgram = NodePointProgram;
  sigmaRendering_cjs_prod.createEdgeDoubleArrowProgram = createEdgeDoubleArrowProgram;
  sigmaRendering_cjs_prod.createEdgeDoubleClampedProgram = createEdgeDoubleClampedProgram;
  return sigmaRendering_cjs_prod;
}
var hasRequiredSigmaRendering_cjs;
function requireSigmaRendering_cjs() {
  if (hasRequiredSigmaRendering_cjs) return sigmaRendering_cjs$1.exports;
  hasRequiredSigmaRendering_cjs = 1;
  {
    sigmaRendering_cjs$1.exports = /* @__PURE__ */ requireSigmaRendering_cjs_prod();
  }
  return sigmaRendering_cjs$1.exports;
}
var sigmaRendering_cjsExports = /* @__PURE__ */ requireSigmaRendering_cjs();
const sigmaRendering_cjs = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  AbstractEdgeProgram: sigmaRendering_cjsExports.AbstractEdgeProgram,
  AbstractNodeProgram: sigmaRendering_cjsExports.AbstractNodeProgram,
  AbstractProgram: sigmaRendering_cjsExports.AbstractProgram,
  DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS: sigmaRendering_cjsExports.DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS,
  DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS: sigmaRendering_cjsExports.DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS,
  DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS: sigmaRendering_cjsExports.DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS,
  EdgeArrowHeadProgram: sigmaRendering_cjsExports.EdgeArrowHeadProgram,
  EdgeArrowProgram: sigmaRendering_cjsExports.EdgeArrowProgram,
  EdgeClampedProgram: sigmaRendering_cjsExports.EdgeClampedProgram,
  EdgeDoubleArrowProgram: sigmaRendering_cjsExports.EdgeDoubleArrowProgram,
  EdgeDoubleClampedProgram: sigmaRendering_cjsExports.EdgeDoubleClampedProgram,
  EdgeLineProgram: sigmaRendering_cjsExports.EdgeLineProgram,
  EdgeProgram: sigmaRendering_cjsExports.EdgeProgram,
  EdgeRectangleProgram: sigmaRendering_cjsExports.EdgeRectangleProgram,
  EdgeTriangleProgram: sigmaRendering_cjsExports.EdgeTriangleProgram,
  NodeCircleProgram: sigmaRendering_cjsExports.NodeCircleProgram,
  NodePointProgram: sigmaRendering_cjsExports.NodePointProgram,
  NodeProgram: sigmaRendering_cjsExports.NodeProgram,
  Program: sigmaRendering_cjsExports.Program,
  createEdgeArrowHeadProgram: sigmaRendering_cjsExports.createEdgeArrowHeadProgram,
  createEdgeArrowProgram: sigmaRendering_cjsExports.createEdgeArrowProgram,
  createEdgeClampedProgram: sigmaRendering_cjsExports.createEdgeClampedProgram,
  createEdgeCompoundProgram: sigmaRendering_cjsExports.createEdgeCompoundProgram,
  createEdgeDoubleArrowProgram: sigmaRendering_cjsExports.createEdgeDoubleArrowProgram,
  createEdgeDoubleClampedProgram: sigmaRendering_cjsExports.createEdgeDoubleClampedProgram,
  createNodeCompoundProgram: sigmaRendering_cjsExports.createNodeCompoundProgram,
  drawDiscNodeHover: sigmaRendering_cjsExports.drawDiscNodeHover,
  drawDiscNodeLabel: sigmaRendering_cjsExports.drawDiscNodeLabel,
  drawStraightEdgeLabel: sigmaRendering_cjsExports.drawStraightEdgeLabel,
  getAttributeItemsCount: sigmaRendering_cjsExports.getAttributeItemsCount,
  getAttributesItemsCount: sigmaRendering_cjsExports.getAttributesItemsCount,
  killProgram: sigmaRendering_cjsExports.killProgram,
  loadFragmentShader: sigmaRendering_cjsExports.loadFragmentShader,
  loadProgram: sigmaRendering_cjsExports.loadProgram,
  loadVertexShader: sigmaRendering_cjsExports.loadVertexShader,
  numberToGLSLFloat: sigmaRendering_cjsExports.numberToGLSLFloat
});
export {
  sigmaRendering_cjs as a,
  sigma_cjsExports as s
};
